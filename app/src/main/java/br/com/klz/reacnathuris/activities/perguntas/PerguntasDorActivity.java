...
public class PerguntasDorActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView( R.layout.activity_perguntas_dor );
    ...
    private void initViews() {
        salvar = findViewById( R.id.btn_dor_salvar );
        menuAnamnese =findViewById( R.id.btn_dor_voltar_anamnese );
        menuGeral =findViewById( R.id.btn_dor_voltar_menu );
    }
