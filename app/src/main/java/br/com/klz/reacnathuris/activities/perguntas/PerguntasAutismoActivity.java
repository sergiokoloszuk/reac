...
public class PerguntasAutismoActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView( R.layout.activity_perguntas_autismo );
    ...
    private void initViews() {
        salvar = findViewById( R.id.btn_autismo_salvar );
        menuAnamnese =findViewById( R.id.btn_autismo_voltar_anamnese );
        menuGeral =findViewById( R.id.btn_autismo_voltar_menu );
    }
