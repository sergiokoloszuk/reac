...
public class PerguntasPanicoActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView( R.layout.activity_perguntas_panico );
    ...
    private void initViews() {
        salvar = findViewById( R.id.btn_panico_salvar );
        menuAnamnese =findViewById( R.id.btn_panico_voltar_anamnese );
        menuGeral =findViewById( R.id.btn_panico_voltar_menu );
    }
